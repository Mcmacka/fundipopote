...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center gap-4 mb-8">
        <div class="relative group">
            {{-- MAREKEBISHO: Kusoma 'profile_photo' badala ya 'profile_picture' --}}
    ...
    @enderror
            ...
            <div class="mt-4">
                ...
                <textarea name="bio" rows="3" maxlength="500"
                          placeholder="Describe yourself — your experience, services you offer, and your qualifications..."
                ...
                <div>
                    ...
                    <select name="service_radius_km" required
                        ...
                        @foreach([5, 10, 15, 20, 30, 50] as $km)
                            <option value="{{ $km }}"
                                {{ old('service_radius_km', $profile?->service_radius_km ?? 10) == $km ? 'selected' : '' }}>
                                {{ $km }} km
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-6 mb-5">
            ...
            <p class="text-xs text-slate-400 mb-4">
                Your location helps nearby customers find you quickly.
            </p>
...
<div class="bg-white rounded-2xl border border-slate-100 p-6 mb-8">
    ...
    <div class="mt-8 bg-white rounded-2xl border border-slate-100 p-5">
        ...
        <div class="flex items-start gap-4">
            {{-- MAREKEBISHO: Kusoma 'profile_photo' kwenye Preview Card pia --}}
...
@push('scripts')
<script>
// Auto-preview image selection logic (Imeboreshwa kurekebisha kadi zote mbili)
document.getElementById('profile-pic-input').addEventListener('change', function(event) {
    const reader = new FileReader();
    reader.onload = function() {
        // 1. Rekebisha Avatar ya Juu
        ...
        // 2. Rekebisha Avatar ya kwenye Preview Card ya Chini (Kama ipo)
...
function getGPS() {
    ...
    navigator.geolocation.getCurrentPosition(
        function(pos) {
            ...
            status.textContent = 'GPS location acquired!';
            status.style.color = '#1D9E75';
        },
        function() {
            status.textContent = 'Failed. Please enable GPS permissions and try again.';
