    ...
    <div class="space-y-4">
        @forelse($notifications as $notification)
            @php
                ...
                // Tunatambua route kulingana na Role ya aliyelogin
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between gap-6 hover:border-gray-200 transition-all">
                ...
                @if($bookingId)
                    <div class="shrink-0">
                        <a href="{{ $viewRoute }}" 
                           class="inline-block px-5 py-2 bg-emerald-600 text-white text-sm font-semibold rounded-xl hover:bg-emerald-700 transition-colors shadow-sm">
                           View
                        </a>
                    </div>
                @endif
