  ...
  <div class="w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row min-h-[600px] z-10 overflow-hidden md:overflow-visible">
    ...
    <div class="w-full md:w-2/5 bg-gradient-to-br from-emerald-500 to-teal-600 text-white p-8 md:p-12 flex flex-col justify-between items-center text-center relative rounded-t-2xl md:rounded-t-none md:rounded-l-2xl">
      ...
      <div class="my-auto space-y-4 max-w-xs py-4 md:py-0">
        <div class="text-white text-5xl font-light tracking-wide hello-text mb-2 select-none">
          hello
        </div>
        ...
        <p class="text-sm font-light leading-relaxed opacity-90">
          To stay connected with our community, please register your account details here.
        </p>
        <div class="pt-4">
          <a href="{{ route('login') }}" class="inline-block px-10 py-2.5 border-2 border-white rounded-full font-medium tracking-wide text-sm uppercase transition-all duration-300 hover:bg-white hover:text-emerald-600 focus:outline-none">
            Sign In
          </a>
        </div>
      </div>
    ...
    <div class="w-full md:w-3/5 p-8 md:p-10 flex flex-col justify-center items-center bg-slate-50/50 rounded-b-2xl md:rounded-b-none md:rounded-r-2xl">
      <div class="w-full max-w-sm text-center">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-3.5 text-left">
          ...
          <div class="relative flex items-center">
            ...
            <input 
              ...
              class="w-full pl-11 pr-4 py-2.5 bg-gray-100 rounded-xl text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-emerald-500/30 transition-all border border-transparent focus:border-emerald-500"
            />
          </div>
          ...
          <div class="relative flex items-center">
            ...
            <select 
              name="role" 
              required
              class="w-full pl-11 pr-10 py-2.5 bg-gray-100 rounded-xl text-sm text-gray-700 appearance-none focus:outline-none focus:bg-white focus:ring-2 focus:ring-emerald-500/30 transition-all border border-transparent focus:border-emerald-500"
            >
          ...
          <div class="pt-2 flex justify-center">
            <button 
              type="submit" 
              class="w-full px-16 py-3 bg-emerald-600 text-white font-medium text-sm tracking-wider uppercase rounded-full shadow-lg shadow-emerald-600/20 hover:bg-emerald-700 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-emerald-500/30 active:scale-95"
            >
              Register
            </button>
          </div>
        ...
        <p class="text-center text-xs text-gray-400 mt-5">
          ...
          <a href="{{ route('login') }}" class="text-emerald-600 hover:underline font-medium ml-1">
             Sign In here
          </a>
        </p>
